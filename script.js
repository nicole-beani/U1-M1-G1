"use strict";
function totaleVincitore(firstGiocatore, secondGiocatore) {
    if (firstGiocatore < 1 ||
        firstGiocatore > 100 ||
        secondGiocatore < 1 ||
        secondGiocatore > 100) {
        ...
        let firstDifferenza = Math.abs(numRandom - firstGiocatore);
        let secondDifferenza = Math.abs(numRandom - secondGiocatore);
